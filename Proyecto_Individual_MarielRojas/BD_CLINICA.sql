...
CREATE TABLE MEDICO (
	...
	ESPECIALIDAD VARCHAR(30) CHECK(ESPECIALIDAD IN('GENERAL','PEDIATRÍA','OBSTETRICIA/GINECOLOGÍA',
	'INTERNA','CARDIOLOGÍA','OFTALMOLOGÍA','OTORRINOLARINGOLOGÍA','DERMATOLOGÍA')) NOT NULL,
	ACTIVO BIT DEFAULT 0
)
GO
