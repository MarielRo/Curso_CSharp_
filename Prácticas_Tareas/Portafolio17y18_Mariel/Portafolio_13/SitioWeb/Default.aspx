...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="grdListaProdu" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No hay productos para mostar" ForeColor="#333333" GridLines="None" Width="100%" PageSize="5" OnSelectedIndexChanged="grdListaProdu_SelectedIndexChanged">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
